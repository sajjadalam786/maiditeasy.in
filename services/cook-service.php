...
?>
    <main>
        ...
        <div class="tp-page-title-area pt-180 pb-185 position-relative fix" data-background="../assets/img/slider/breadcrumb-bg-1.jpg" role="img" aria-label="Banner image placeholder for hire cook service and cooks near me">
                ...
                <div class="mobile-image-slider">
                    <div class="slider-wrapper">
                        <div class="slider-item">
                            <span>Image 1: North Indian Cook</span>
                        </div>
                        <div class="slider-item">
                            <span>Image 2: South Indian Kitchen Cook</span>
                        </div>
                        <div class="slider-item">
                            <span>Image 3: Brahmin Cook & Pure Vegetarian Meals</span>
                        </div>
                        <div class="slider-item">
                            <span>Image 4: Multi-cuisine Chef for Home</span>
                        </div>
                    </div>
                </div>
